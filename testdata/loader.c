...
static int __attribute__((noinline)) __section("static")
    static_fn(uint32_t arg) {
  return arg - 1;
}

int __attribute__((noinline)) global_fn2(uint32_t arg) { return arg + 2; }
...
__section("socket") int no_relocation() { return 0; }
...
#else
__section("socket/3") int data_sections() { return 0; }
#endif
